                    ...
                    @else
                        <button class="btn font-weight-bold p-0 dropdown-toggle text-secondary" type="button" data-bs-toggle="dropdown">@lang('thoughtco.outofstock::default.button_nostock')</button>
